...
![QA Workflow Status](https://img.shields.io/github/actions/workflow/status/data5tream/simple-web-healthcheck-rs/check.yml?label=QA&style=for-the-badge)
...
> The `simple-web-healthcheck` binary currently has a size of around 496 KB.
